  ...
  <div class="min-h-screen bg-corporate-gray-light">
    ...
    <footer class="bg-gradient-to-br from-corporate-navy via-corporate-dark to-corporate-blue text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <!-- Top Border Line -->
        <div class="w-full h-1 bg-gradient-to-r from-corporate-blue via-white to-corporate-light-blue mb-12"></div>
        
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
          <!-- Company Info -->
          <div class="col-span-1 md:col-span-2">
            <div class="flex items-center mb-6">
              <div class="w-12 h-12 bg-gradient-to-br from-corporate-blue to-corporate-light-blue rounded-lg flex items-center justify-center mr-3 shadow-corporate">
            ...
            <div class="flex space-x-4">
              <a href="#" class="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all hover:scale-110 transform">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Satın Al</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">İlan Ver</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Kirala</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Ev Değerleme</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Danışman Bul</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Yardım Merkezi</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">İletişim</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Gizlilik Politikası</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Kullanım Şartları</a></li>
              <li><a href="#" class="text-white/80 hover:text-white transition-colors font-medium font-body">Çerez Politikası</a></li>
            </ul>
          </div>
        </div>

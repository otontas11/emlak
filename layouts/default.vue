  ...
  <div class="min-h-screen bg-gray-50">
          ...
          <div class="flex items-center space-x-4">
            ...
            <template v-else>
              <div class="relative group">
                ...
                <!-- Profile Dropdown -->
                <div v-if="showProfileMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  <!-- Consultant specific options -->
                  <template v-if="authStore.user?.isConsultant">
                    <NuxtLink to="/consultant-profile" class="block px-4 py-2 text-sm text-green-600 hover:bg-green-50 font-medium">
                      <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                      </svg>
                      Danışman Profilim
                    </NuxtLink>
                    <NuxtLink to="/consultant-properties" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                      </svg>
                      Atanan İlanlarım
                  ...
                  <template v-else>
                    ...
                    <NuxtLink to="/my-listings" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                      </svg>
                      İlanlarım
    ...
    <footer class="bg-gray-900 text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <!-- Top Border Line -->
        <div class="w-full h-1 bg-gradient-to-r from-blue-500 via-green-500 to-indigo-500 mb-8"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-2">
            <div class="flex items-center mb-6">
              ...
              <span class="text-2xl font-bold text-white">Emlak Danışmanınız</span>
            </div>
            <p class="text-gray-300 mb-6 max-w-md">
              Türkiye'nin en güvenilir emlak platformu. Doğru evi, doğru fiyata bulun.
            </p>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Satın Al</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Sat</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Kirala</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Mortgage</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Danışman Bul</a></li>
            </ul>
          </div>
          
          <!-- Support -->
          <div>
            <h3 class="text-lg font-semibold text-white mb-4">Destek</h3>
            <ul class="space-y-2">
              ...
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Çerez Politikası</a></li>
            </ul>
          </div>
        </div>

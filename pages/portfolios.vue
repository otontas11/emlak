  ...
  <NuxtLayout name="default">
    <div class="min-h-screen bg-gray-50 py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-8">
          <h1 class="text-3xl font-bold text-gray-900">Portföy Paylaşımı</h1>
          <p class="text-gray-600 mt-2">Emlakçıların paylaştığı portföyleri keşfedin</p>
        </div>
        ...
        <div class="flex justify-between items-center mb-6">
          <p class="text-gray-600">{{ properties.length }} portföy bulundu</p>

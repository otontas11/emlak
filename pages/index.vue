    ...
    <section class="py-20 bg-white">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <!-- For Buyers -->
          <div class="bg-gradient-to-br from-corporate-navy to-corporate-blue rounded-2xl p-8 shadow-corporate-lg text-white">
            <div class="flex items-center mb-6">
              <div class="w-10 h-10 bg-corporate-gold rounded-lg flex items-center justify-center mr-3">
            ...
            <div class="space-y-5">
              <div class="flex items-start space-x-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all">
                <div class="w-12 h-12 bg-corporate-gold rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- For Sellers -->
          <div class="bg-gradient-to-br from-corporate-gold to-corporate-dark-gold rounded-2xl p-8 shadow-corporate-lg text-white">
            <div class="flex items-center mb-6">
              <div class="w-10 h-10 bg-corporate-navy rounded-lg flex items-center justify-center mr-3">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-5">
              <div class="flex items-start space-x-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all">
                <div class="w-12 h-12 bg-corporate-navy rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">

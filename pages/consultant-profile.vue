          ...
          <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-lg p-6">
              ...
              <div class="space-y-3">
                ...
                <NuxtLink to="/my-certificates" class="w-full flex items-center space-x-3 text-gray-700 hover:text-green-600 hover:bg-green-50 p-3 rounded-lg transition-colors">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
